    ...
    <>
      ...
      <main className="relative max-w-2xl px-6 sm:px-10 md:pl-24 md:pr-16 lg:pl-48 lg:pr-20 py-20 sm:py-24 md:py-28 min-h-[calc(100dvh-3rem)] sm:min-h-[calc(100dvh-3.5rem)]">
        ...
        <section className="space-y-10 sm:space-y-12 mb-14 sm:mb-16">
          ...
          <blockquote className="border-l border-white/15 pl-5 sm:pl-6">
            <p className="text-[16px] sm:text-[17px] leading-loose text-white/85 font-light">
              이 후에 내가 돌아와서 다윗의 무너진 장막을 다시 지으며 또 그
              허물어진 것을 다시 지어 일으키리니 이는 그 남은 사람들과 내
              이름으로 일컬음을 받는 모든 이방인들로 주를 찾게 하려 함이라
              하셨으니
            </p>
            <cite className="block mt-3 sm:mt-4 text-[12px] sm:text-[13px] text-white/45 not-italic tracking-[0.2em] uppercase">
              Acts · 사도행전 15:16-17
        ...
        <section className="space-y-6 sm:space-y-7">
          <p className="text-[16px] sm:text-[17px] leading-loose text-white/80 font-light">
            &lsquo;쉬르밴드&rsquo;는 길이요 진리이며 영원한 왕이신
            예수그리스도만을 높이고 주님의 교회와 개인의 삶에 예배가 회복되길(행
            15:16) 기도하며 나아갑니다.
          </p>
          <p className="text-[16px] sm:text-[17px] leading-loose text-white/80 font-light">
            복음의 능력을 믿으며(롬1:16) 영원토록 예배받으실 분은 한
            분이시며(계5:12-13) 다시 오실 영원한 왕을 바라보며(계22:20)
            예수그리스도 안에서 모든 민족이 하나님께로 돌아오고 진정한 예배가
            회복 될 것을 믿고 참된 복음 안에서 삼위일체 하나님을 예배하며
            선포하는 사역을 합니다.
          </p>
        </section>
      </main>
