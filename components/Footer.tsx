...
export default function Footer() {
  ...
  return (
    <>
      <footer className="bg-white border-t border-gray-200 py-5 sm:py-6">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-5 text-center sm:text-left">
              <a
                ...
                className="text-xs sm:text-sm text-gray-700 hover:text-gray-900 transition-colors"
              >
            ...
            <div className="flex items-center justify-center sm:justify-end gap-4">
              <div className="flex items-center gap-2">
                <a
                  ...
                  className="w-7 h-7 bg-gradient-to-r from-purple-500 to-pink-500 rounded-md flex items-center justify-center hover:scale-110 transition-transform"
                >
                  <svg
                ...
                <a
                  ...
                  rel="noopener noreferrer"
                  aria-label="YouTube"
                  className="w-7 h-7 bg-red-600 rounded-md flex items-center justify-center hover:scale-110 transition-transform"
                >
                  <svg
                    className="w-3.5 h-3.5 text-white"
                    fill="currentColor"
              ...
              <div className="flex items-center gap-3 text-[11px] sm:text-xs">
                ...
                <Link
                  href="/manage"
                  aria-label="관리자"
                  className="inline-flex items-center justify-center w-5 h-5 rounded-full border border-gray-300 text-gray-400 hover:text-gray-900 hover:border-gray-900 transition-colors"
                >
                  <svg
